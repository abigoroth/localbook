...
class UserFriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_friend" do
    assert_difference('UserFriend.count') do
      post user_friends_url, params: { user_friend: { friend_id: @user_friend.friend_id, id: @user_friend.id, user_id: @user_friend.user_id } }
    end
  ...
  test "should update user_friend" do
    patch user_friend_url(@user_friend), params: { user_friend: { friend_id: @user_friend.friend_id, id: @user_friend.id, user_id: @user_friend.user_id } }
